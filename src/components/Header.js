...
import '../styles/Header.css'; // Styles for Header
  ...
  return (
    <header className="app-header">
      <div className="header-container">
        <h1 className="logo-header">Diwakar Shaw</h1>
        <nav className="main-nav">
          {navItems.map(item => (
            <ScrollLink
              key={item.id}
              to={item.id} // This 'to' prop corresponds to the 'name' prop of the Element in each section
              spy={true} // Makes the link selected when scroll is at its target's position
              smooth={true} // Animates the scrolling
              offset={-70} // Scrolls to element + 70 pixels (negative for scrolling below header)
        ...
        <div className="social-links">
          {/* LinkedIn SVG Icon */}
          <a href="https://www.linkedin.com/in/diwakar-shaw-245567284/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="social-icon-link">
          ...
          {/* GitHub SVG Icon */}
          <a href="https://github.com/Diwakar1706" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="social-icon-link">
